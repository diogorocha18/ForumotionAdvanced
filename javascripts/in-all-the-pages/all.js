  ...
  if (_userdata.user_id == 1 && !my_getcookie('fae_update_alerted')) {
    ...
    $.get('https://raw.githubusercontent.com/diogorocha18/ForumotionAdvanced/development/javascripts/version-data.js', function(d) {
      ...
      if (forumactif_edge_version_data.length < fae_github_version_data.length) {
        alert('An update has been found for Forumotion Advanced. When you\'re ready, please proceed to your FAE Control Panel and click "Check for updates" to begin the update process.');
      }
