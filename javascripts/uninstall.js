...
FAE.next = function() {
  if (++FAE.index >= FAE.quota) {
    FAE.log('Uninstallation of Forumotion Advanced has been completed successfully!', 'color:#8B5;font-weight:bold;');
...
FAE.error = function() {
  FAE.log('An error was encountered on step ' + FAE.index + ' (' + FAE.step[FAE.index].info + ') of the uninstallation process. Please <a href="https://github.com/diogorocha18/ForumotionAdvanced/wiki/Support-and-Discussion" target="_blank">open a new issue</a> and provide this information for further assistance.', 'color:#E53;font-weight:bold;');
  window.setTimeout(FAE.next, FAE.delay);
};
