// German Translation
// Translation by Bigtuber & schiggysboard (http://fmdesign.forumotion.com/t729-ForumotionAdvanced-german-translation#14318)
FAE.lang = {
  ...
  javascripts : {
    ...
    '[FA EDGE] ALL.JS' : {
      ...
      fae_update_found : 'Es wurde ein Update für Forumotion Advanced gefunden. Wenn Sie bereit sind, gehen Sie bitte zu Ihrem FAE-Bedienungsfeld und klicken Sie auf "Nach Updates überprüfen", um den Update-Prozess zu starten.'
    },
  ...
  templates : {
    ...
    'overall_footer_end.html' : {
      ...
      fae_feedback_tooltip : 'Helfen, Forumotion Advanced zu verbessern'
    },
  ...
  fae_cp : {
    fae_cp_main_title : 'Forumotion Advanced-Bedienungsfeld',
    fae_cp_desc : 'Dieses Bedienungsfeld erlaubt es Ihnen, <a href="https://github.com/diogorocha18/ForumotionAdvanced" target="_blank">Forumotion Advanced</a> zu installieren, deinstallieren, und aktualisieren. Machen Sie sich bereit, Ihr Forum in einem modernen und ansprechendem Weg zu präsentieren!',
    fae_log : 'Protokoll',
    ...
    fae_install_warning : 'Sind Sie sicher, Forumotion Advanced zu {INSTALL}? Dies wird Ihr aktuelles Thema überschreiben und Ihre aktuellen JavaScripts löschen.\\\n\\\nBitte stellen Sie sicher, alle persönlichen Inhalts-Dateien wie CSS, Templates, und JavaScripts bevor Sie fortfahren, zu sichern. Klicken Sie auf "Abbrechen" falls Sie nicht bereit sind,  Forumotion Advanced zu installieren.',

    fae_uninstall : 'Deinstallieren',
    fae_uninstall_warning : 'Sind Sie sicher, Forumotion Advanced zu deinstallieren? Alle CSS, JavaScript, und Template-Veränderungen werden gelöscht; das Forum wird zum voreingestelltem phpbb3-Thema zurückgesetzt.\\\n\\\nBitte stellen Sie sicher, alle persönlichen Inhalts-Dateien wie CSS, Templates, und JavaScripts bevor Sie fortfahren, zu sichern. Klicken Sie auf "Abbrechen" falls Sie Forumotion Advanced doch nicht deinstallieren möchten.',

    fae_update : 'Nach Updates überprüfen',
    fae_update_good : 'Forumotion Advanced ist auf dem neuesten Stand!',
    ...
    fae_update_error : 'Update-Anweisungen für Version {VERSION_STRING} konnten nicht gefunden werden. Bitte <a href="http://fmdesign.forumotion.com/t700-ForumotionAdvanced-support#13923" target="_blank">öffnen Sie ein neues Support-Ticket</a> und geben Sie diese Informationen an, um weitere Hilfe zu erhalten.',

    fae_translate : 'Sprache verändern',
    fae_translate_same : 'Forumotion Advanced ist bereits in {LANG}. Bitte wählen Sie eine andere Sprache.',
    fae_translate_warning : 'Sind Sie sicher, die Sprache von Forumotion Advanced zu verändern; {LANG} ?',
    fae_translate_start : 'Übersetzungen von Forumotion Advanced werden in Kürze eingeleitet. Bitte warten..',
    ...
    fae_err_not_founder : 'Nur <a href="/u1">der Gründer</a> kann dieses Bedienungsfeld benutzen. Bitte kontaktieren Sie ihn, um Hilfe bezüglich der Installation von Forumotion Advanced zu erhalten..',
    ...
    general_settings : {
      ...
      fae_gen_desc : 'Dieser Bereich erlaubt es Ihnen, die allgemeinen Einstellungen von Forumotion Advanced zu verwalten.',
    ...
    theme_management : {
      ...
      fae_theme_desc : 'Dieser Bereich erlaubt es Ihnen, das voreingestellte Thema und Farben für Forumotion Advanced zu verändern, indem Sie ein neues Thema von der Github-Repository importieren.',
