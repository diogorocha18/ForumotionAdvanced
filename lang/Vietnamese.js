...
// Translation by Lorem (http://fmdesign.forumotion.com/t988-ForumotionAdvanced-vietnamese-translation#19997)
FAE.lang = {
  ...
  images : {
    ...
    buttons : {
      i_post : 'https://i35.servimg.com/u/f35/18/21/60/73/new-to14.png?color=primary&size=m',
      i_reply : 'https://i35.servimg.com/u/f35/18/21/60/73/post-r14.png?color=primary&size=m',
      i_reply_locked : 'https://i35.servimg.com/u/f35/18/21/60/73/locked14.png?color=secondary&size=m',
      i_icon_quote : 'https://i35.servimg.com/u/f35/18/21/60/73/quote-14.png?color=primary&size=s',
      i_icon_multiquote_off : 'https://i35.servimg.com/u/f35/18/21/60/73/multi-14.png?color=primary&size=s',
      i_icon_multiquote_on : 'https://i35.servimg.com/u/f35/18/21/60/73/multi-14.png?color=secondary&size=s',
      i_icon_thanks_off : 'https://i35.servimg.com/u/f35/18/21/60/73/thanks14.png?color=primary&size=s',
      i_icon_thanks_on : 'https://i35.servimg.com/u/f35/18/21/60/73/thanks14.png?color=secondary&size=s',
      i_icon_edit : 'https://i35.servimg.com/u/f35/18/21/60/73/edit-v10.png?color=primary&size=s',
      ...
      i_msg_newpost : 'https://i35.servimg.com/u/f35/18/21/60/73/new-pm14.png?color=primary&size=m',
    ...
    gallery : {
      upload_pic : 'https://i35.servimg.com/u/f35/18/21/60/73/upload14.png?color=primary&size=m'
    }
  ...
  javascripts : {
    ...
    '[FA EDGE] ALL.JS' : {
      ...
      fae_update_found : 'Một bản cập nhật đã được tìm thấy cho Forumotion Advanced. Khi bạn đã sẵn sàng, xin vui lòng truy cập vào FAE Control Panel và nhấp vào "Check for updates" để bắt đầu quá trình cập nhật.'
    },
  ...
  templates : {
    ...
    'overall_footer_end.html' : {
      ...
      fae_feedback_tooltip : 'Giúp cải thiện Forumotion Advanced'
    },
  ...
  fae_cp : {
    fae_cp_main_title : 'Bảng điều khiển Forumotion Advanced',
    fae_cp_desc : 'Bảng điều khiển này cho phép bạn cài đặt, gỡ bỏ và cập nhật <a href="https://github.com/diogorocha18/ForumotionAdvanced" target="_blank">Forumotion Advanced</a>.Hãy sẵn sàng để trải nghiệm diễn đàn của bạn theo phong cách hiện đại và tương tác nhanh hơn!',
    fae_log : 'Thay đổi',
    ...
    fae_install_warning : 'Bạn có chắn chắn muốn {INSTALL} Forumotion Advanced? Nó sẽ ghi đè lên giao diện và xóa các JavaScripts hiện tại của bạn.\\\n\\\nHãy chắc chắn là bạn đã sao lưu các nội dung cá nhân của bạn như CSS, Templates, và JavaScripts trước khi tiếp tục. Nhấn vào "Cancel" nếu bạn chưa sẵn sàng để cài đặt Forumotion Advanced.',

    fae_uninstall : 'Gỡ bỏ cài đặt',
    fae_uninstall_warning : 'Bạn có chắc chắn bạn muốn gỡ bỏ cài đặt Forumotion Advanced? Tất cả CSS, JavaScript, và Template sẽ bị xóa ; Diễn đàn này sẽ được chuyển về giao diện phpBB3 mặc định.\\\n\\\nHãy chắc chắn là bạn đã sao lưu các nội dung cá nhân của bạn như CSS, Templates, và JavaScripts trước khi tiếp tục. Nhấn vào "Cancel" nếu bạn không muốn gỡ bỏ Forumotion Advanced.',

    fae_update : 'Kiểm tra cập nhật',
    fae_update_good : 'Forumotion Advanced đã được cập nhật!',
    ...
    fae_update_error : '	Không tìm thấy phiên bản cập nhật {VERSION_STRING}. Hãy <a href="http://fmdesign.forumotion.com/t700-ForumotionAdvanced-support#13923" target="_blank">gửi một yêu cầu hỗ trợ</a> và cung cấp thông tin để được hỗ trợ.',

    fae_translate : 'Thay đổi ngôn ngữ',
    fae_translate_same : 'Forumotion Advanced đã có trong {LANG}. Vui lòng chọn một ngôn ngữ khác.',
    fae_translate_warning : 'Bạn có chắn chắn muốn thay đổi ngôn ngữ của Forumotion Advanced thành {LANG} ?',
    fae_translate_start : 'Quá trình dịch của Forumotion Advanced sẽ bắt đầu ngay. Vui lòng đợi..',
    ...
    configuration_desc : 'Clicking the buttons below will take you to different sections of the control panel, which allow you to manage the Configuration of Forumotion Advanced. Go ahead and explore each of these sections, so you can get started on personalizing your theme. If you need more information, <a href="https://github.com/diogorocha18/ForumotionAdvanced/wiki/FAE-Control-Panel-Guide" target="_blank">click here</a> to view the control panel guide.',
    fae_err_not_founder : 'Chỉ có <a href="/u1">người sáng lập</a> mới có thể sử dụng bảng điều khiển này. Hãy liên hệ với họ để được giúp đỡ trong việc cài đặt Forumotion Advanced.',
    co_admin : 'Only <a href="/u1">the founder</a> can access the installation, update, and translation actions. Since Forumotion Advanced is installed, you can still access some core features for personalizing your forum via the "Configuration" section below.',
    reload_page : 'Please <a href="javascript:window.location.reload();">click here</a> to reload the page.',


    welcome_message : 'Welcome to the FAE Control Panel! The FAE CP will allow you to install, update, translate, and customize Forumotion Advanced. To learn more about using the FAE CP, it is recommended that you read over the <a href="https://github.com/diogorocha18/ForumotionAdvanced/wiki/FAE-Control-Panel-Guide" target="_blank">Control Panel Guide</a> on the Github wiki.',
    auto_version_local : 'Your installed version of Forumotion Advanced is <a href="https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/{VERSION_STRING}" target="_blank">{VERSION_STRING}</a>.',
    auto_version_github : 'The current release of Forumotion Advanced on Github is <a href="https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/{VERSION_STRING}" target="_blank">{VERSION_STRING}</a>.',
    update_waiting : 'There are updates available for Foruactif Edge. Check out <a href="https://github.com/diogorocha18/ForumotionAdvanced/wiki/Checking-for-updates" target="_blank">the wiki</a> for more information about updating.',
    release_list : '<a href="https://github.com/diogorocha18/ForumotionAdvanced/releases" target="_blank">Click here</a> to see the full list of releases for Forumotion Advanced.',
    ...
    general_settings : {
      ...
      fae_gen_desc : 'This section allows you to manage the general settings of Forumotion Advanced.',
    ...
    colors : {
      ...
      'fae_colors_desc-primary' : 'The options below allow you to adjust the 5 primary color shades for Forumotion Advanced.',
    ...
    theme_management : {
      ...
      fae_theme_desc : 'This section allows you to manage the default theme and colors for Forumotion Advanced by importing a new theme from the Github repository.',
    ...
    plugin_management : {
      ...
      fae_plugin_desc : 'This section allows you to manage the settings of core-plugins for Forumotion Advanced.',
