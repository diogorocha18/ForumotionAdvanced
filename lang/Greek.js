// Greek Translation
// Translation by Luffy and Van-Helsing (http://fmdesign.forumotion.com/t710-ForumotionAdvanced-greek-translation#14037)
FAE.lang = {
  ...
  images : {
    ...
    buttons : {
      i_post : 'https://i35.servimg.com/u/f35/18/45/41/65/new-el10.png?color=primary&size=m',
      i_reply : 'https://i35.servimg.com/u/f35/18/45/41/65/post-r10.png?color=primary&size=m',
      i_reply_locked : 'https://i35.servimg.com/u/f35/18/45/41/65/locked11.png?color=secondary&size=m',
      i_icon_quote : 'https://i35.servimg.com/u/f35/18/45/41/65/quote-10.png?color=primary&size=s',
      i_icon_multiquote_off : 'https://i35.servimg.com/u/f35/18/45/41/65/multi-10.png?color=primary&size=s',
      i_icon_multiquote_on : 'https://i35.servimg.com/u/f35/18/45/41/65/multi-10.png?color=secondary&size=s',
      i_icon_thanks_off : 'https://i35.servimg.com/u/f35/18/45/41/65/thanks10.png?color=primary&size=s',
      i_icon_thanks_on : 'https://i35.servimg.com/u/f35/18/45/41/65/thanks10.png?color=secondary&size=s',
      i_icon_edit : 'https://i35.servimg.com/u/f35/18/45/41/65/edit-e10.png?color=primary&size=s',
      ...
      i_msg_newpost : 'https://i35.servimg.com/u/f35/18/45/41/65/new-pm10.png?color=primary&size=m',
    ...
    gallery : {
      upload_pic : 'https://i35.servimg.com/u/f35/18/45/41/65/upload10.png?color=primary&size=m'
    }
  ...
  javascripts : {
    ...
    '[FA EDGE] ALL.JS' : {
      ...
      fae_update_found : 'Μία αναβάθμιση βρέθηκε για το Forumotion Advanced. Όταν είστε σε θέση, παρακαλούμε προχωρήστε στον Πίνακα Ελέγχου FAE και πατήστε το κουμπί "Check for updates" για την έναρξη της αναβάθμισης.'
    },
  ...
  templates : {
    ...
    'overall_footer_end.html' : {
      ...
      fae_feedback_tooltip : 'Βοηθήστε στην βελτίωση του Forumotion Advanced'
    },
  ...
  fae_cp : {
    fae_cp_main_title : 'Πίνακας Ελέγχου Forumotion Advanced',
    fae_cp_desc : 'Αυτός ο πίνακας σας επιτρέπει να εγκαταστήσετε, να απενεγκαταστήσετε και να αναβαθμίσετε το <a href="https://github.com/diogorocha18/ForumotionAdvanced" target="_blank">Forumotion Advanced</a> φόρουμ σας. Ετοιμαστείτε να αντιμετωπίσετε την υπέροχη και μοναδική εμπειρία που προσφέρει το Forumotion Advanced στο φόρουμ σας!',
    fae_log : 'Πληροφορίες',
    ...
    fae_install_warning : 'Είστε σίγουροι ότι θέλετε να {INSTALL} το Forumotion Advanced; Κάνοντας αυτή την ενέργεια συμφωνείτε στο να διαγραφεί το παρών θέμα του φόρουμ σας για να προστεθεί το νέο θέμα και να διαγραφούν όλα τα JavaScripts που έχετε εγκαταστήσει.\\\n\\\nΠαρακαλούμε όπως κρατήσετε αρχεία ασφαλείας για όλα τα απαραίτητα αρχεία που μπορεί να χρειαστείτε όπως CSS, Πρότυπα, JavaScripts και οπουδήποτε αλλού ίσως χρειαστεί προτού προχωρήσετε. Πατήστε "Ακύρωση" αν δεν είστε έτοιμοι να εγκαταστήσετε ξανά το Forumotion Advanced.',

    fae_uninstall : 'Απεγκατάσταση',
    fae_uninstall_warning : 'Είστε σίγουροι ότι θέλετε να απεγκαταστήσετε το Forumotion Advanced; Το CSS, τα JavaScripts καθώς επίσης και τα Πρότυπα θα διαγραφούν τελείως. Το φόρουμ θα επιστρέψει στην αρχική του μορφή και στο αρχικό του phpbb3 θέμα.\\\n\\\nΠαρακαλούμε όπως κρατήσετε αρχεία ασφαλείας για όλα τα απαραίτητα αρχεία που μπορεί να χρειαστείτε όπως CSS, Πρότυπα, JavaScripts και οπουδήποτε αλλού ίσως χρειαστεί προτού προχωρήσετε. Πατήστε "Ακύρωση" αν δεν είστε έτοιμοι να απεγκαταστήσετε το Forumotion Advanced ακόμα.',

    fae_update : 'Έλεγχος για αναβαθμίσεις',
    fae_update_good : 'Το Forumotion Advanced είναι πλήρως αναβαθμίσμένο!',
    ...
    fae_update_error : 'Οι πληροφορίες αναβάθμισης για την μορφή {VERSION_STRING} δεν βρέθηκαν. Παρακαλούμε <a href="http://fmdesign.forumotion.com/t700-ForumotionAdvanced-support#13923" target="_blank">ανοίξτε ένα νέο ticket υποστήριξης</a> και εισάγετε αυτές τις πληροφορίες για καλύτερη εξυπηρέτηση',

    fae_translate : 'Αλλαγή γλώσσας',
    fae_translate_same : 'Το Forumotion Advanced είναι ήδη στην γλώσσα {LANG}. Παρακαλούμε επιλέξτε μια άλλη γλώσσα.',
    fae_translate_warning : 'Είστε σίγουροι ότι θέλετε να αλλάξετε την γλώσσα του Forumotion Advanced σε {LANG} ?',
    fae_translate_start : 'Οι μεταφράσεις του Forumotion Advanced θα γίνουν σε λίγο. Παρακαλούμε περιμένετε..',
    ...
    configuration_desc : 'Πατώντας τα κουμπιά παρακάτω μπορείτε να μεταβείτε σε διαφορετικούς τομείς του πίνακα διαχείρισης, οι οποίοι σας επιτρέπουν να διαχειριστείτε τις ρυθμίσεις του Forumotion Advanced. Συνεχίστε και δείτε αυτούς τους τομείς, ώστε να ξεκινήσετε να προσαρμόζετε το θέμα σας. Αν χρειάζεστε περισσότερες πληροφορίες <a href="https://github.com/diogorocha18/ForumotionAdvanced/wiki/FAE-Control-Panel-Guide" target="_blank">πατήστε εδώ</a> για να δείτε τον οδηγό του πίνακα διαχείρισης.',

    fae_err_not_founder : 'Μόνο ο <a href="/u1">ιδρυτής</a> μπορεί να προσπελάσει την ενέργεια εγκατάστασης. Παρακαλούμε επικοινωνήστε μαζί του για βοήθεια σχετικά με την εγκατάσταση του Forumotion Advanced.',
    ...
    welcome_message : 'Καλωσήρθατε στον πίνακα διαχείρισης του FAE! Ο πίνακας διαχείρισης FAE να εγκαταστήσετε, να ενημερώσετε, να μεταφράσετε και να προσαρμόσετε το Forumotion Advanced. Για να μάθετε περισσότερα για τον πίνακα διαχείρισης Forumotion Advanced σας συνιστούμε να διαβάσετε τον <a href="https://github.com/diogorocha18/ForumotionAdvanced/wiki/FAE-Control-Panel-Guide" target="_blank">Οδηγό Πίνακα Διαχείρισης</a> στο GitHub Wiki.',
    auto_version_local : 'Η εγκατεστημένη έκδοση του Forumotion Advanced είναι η <a href="https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/{VERSION_STRING}" target="_blank">{VERSION_STRING}</a>.',
    auto_version_github : 'Η τρέχουσα διαθέσιμη έκδοση στο GitHub είναι η <a href="https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/{VERSION_STRING}" target="_blank">{VERSION_STRING}</a>.',
    update_waiting : 'Υπάρχουν διαθέσιμες ενημερώσεις για το Forumotion Advanced. Διαβάστε στο <a href="https://github.com/diogorocha18/ForumotionAdvanced/wiki/Checking-for-updates" target="_blank">wiki</a> για περισσότερες πληροφορίες σχετικά με την ενημέρωση αυτή.',
    release_list : 'Πατήστε <a href="https://github.com/diogorocha18/ForumotionAdvanced/releases" target="_blank">εδώ</a> Για να δείτε την πλήρη λίστα εκδόσεων του Forumotion Advanced.',
    ...
    general_settings : {
      ...
      fae_gen_desc : 'Αυτός ο τομέας σας επιτρέπει να ορίσετε τις γενικές ρυθμίσεις του Forumotion Advanced.',
    ...
    colors : {
      ...
      'fae_colors_desc-primary' : 'Αυτές οι επιλογές σας επιτρέπουν να ρυθμίσετετα 5 πρωτεύωντα χρώματα σκιών για το Forumotion Advanced.',
    ...
    theme_management : {
      ...
      fae_theme_desc : 'Αυτός ο τομέας σας επιτρέπει να ρυθμίσετε το εξ ορισμού θέμα του φόρουμ όπως επίσης και τα χρώματα του Forumotion Advanced ανεβάζοντας τις πληροφορίες από την πλατφόρμα και το ιστορικό στο Github.',
    ...
    plugin_management : {
      ...
      fae_plugin_desc : 'Αυτός ο τομέας σας επιτρέπει να διαχειριστείτε τις ρυθμίσεις των προσθέτων του πυρήνα του Forumotion Advanced.',
