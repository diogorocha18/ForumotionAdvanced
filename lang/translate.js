...
FAE.next = function() {
  if (++FAE.index >= FAE.quota) {
    FAE.log('Forumotion Advanced has been translated successfully!', 'color:#8B5;font-weight:bold;');
...
FAE.error = function() {
  FAE.log('An error was encountered on step ' + FAE.index + ' (' + FAE.step[FAE.index].info + ') of the translation process. Please <a href="http://fmdesign.forumotion.com/t700-ForumotionAdvanced-support#13923" target="_blank">open a new issue</a> and provide this information for further assistance.', 'color:#E53;font-weight:bold;');
  window.setTimeout(FAE.next, FAE.delay);
};
