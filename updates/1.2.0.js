...
FAE.update_tag = 'https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/v1.2.0';
...
FAE.update_step = [
...

  {
    ...
    func : function(d) {
      ...
      if (form) {
        FAE.step[FAE.index + 1].data.template = form.template.value
                                                .replace("https://github.com/diogorocha18/ForumotionAdvanced", "https://diogorocha18.github.io/ForumotionAdvanced/")
