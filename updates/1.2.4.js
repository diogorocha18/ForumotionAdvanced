...
FAE.update_tag = 'https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/v1.2.4';
  ...
  FAE.update_step = FAE.update_step.concat([
    {
      ...
      type : 'GET',
      url : 'https://raw.githubusercontent.com/diogorocha18/ForumotionAdvanced/8eff7a842f0895282bd88ac7e52fe6582432723d/lang/Italian.js',
      func : function (d) {
  ...
  FAE.update_step = FAE.update_step.concat([
    {
      info : 'Getting old translation file...',
      type : 'GET',
      url : 'https://raw.githubusercontent.com/diogorocha18/ForumotionAdvanced/8eff7a842f0895282bd88ac7e52fe6582432723d/lang/Romanian.js',
      func : function (d) {
        FAE.script(d.replace('FAE.lang', 'FAE.lang_current'));
      }
    },
