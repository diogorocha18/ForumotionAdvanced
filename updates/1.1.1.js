...
FAE.update_tag = 'https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/v1.1.1';
          ...
          FAE.step[FAE.index + 1].data = {
            ...
            'js_placement[]' : 'allpages',
                     content : form.content.value
                               .replace('Es wurde ein Update für Forumotion Advanced gefunden. Wenn Sie bereit sind, gehen Sie bitte zu Ihrem FAE Bedienungsfeld und klicken Sie auf "Nach Updates überprüfen", um den Update-Prozess zu starten.', 'Es wurde ein Update für Forumotion Advanced gefunden. Wenn Sie bereit sind, gehen Sie bitte zu Ihrem FAE-Bedienungsfeld und klicken Sie auf "Nach Updates überprüfen", um den Update-Prozess zu starten.'),
