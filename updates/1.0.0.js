...
FAE.update_tag = 'https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/v1.0.0';
      ...
      if (form) {
        FAE.step[FAE.index + 1].data = {
                edit_code : form.edit_code.value
                            .replace('/development/fa_advanced.css', '/development/css/fa_advanced.css')
    ...
    func : function(d) {
      ...
      if (form) {
        FAE.step[FAE.index + 1].data.template = form.template.value
                                                .replace(/https:\/\/github\.com\/diogorocha18\/ForumotionAdvanced\/issues\/new/g, 'http://fmdesign.forumotion.com/t701-ForumotionAdvanced-suggestions-and-feedback#13925');
      }
    }
  },
