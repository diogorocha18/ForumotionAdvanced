...
FAE.update_tag = 'https://github.com/diogorocha18/ForumotionAdvanced/releases/tag/v1.1.5';
  ...
  FAE.update_step = FAE.update_step.concat([
    {
      ...
      type : 'GET',
       url : 'https://raw.githubusercontent.com/diogorocha18/ForumotionAdvanced/v1.1.4/lang/Dutch.js',
      func : function(d) {
  ...
  FAE.update_step = FAE.update_step.concat([
    {
      ...
      type : 'GET',
       url : 'https://raw.githubusercontent.com/diogorocha18/ForumotionAdvanced/v1.1.4/lang/Arabic.js',
      func : function(d) {
        FAE.script(d.replace('FAE.lang', 'FAE.lang_current'));
      }
    },
